...
--
-- Table structure for table `main_article_quote`
--

CREATE TABLE `main_article_quote` (
...
--
-- Indexes for table `main_article_quote`
--
ALTER TABLE `main_article_quote`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `main_article_quote`
--
ALTER TABLE `main_article_quote`
